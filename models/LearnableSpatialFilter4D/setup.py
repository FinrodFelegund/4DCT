...
setup(
    name='bilateralfilter4D_torch_learnable_spt',
    version='1.1.0',
    ...
    py_modules=['bilateral_filter_layer_learnable_spt', 'gradcheck'],
    ext_modules=[
        CUDAExtension('bilateralfilter4dlearnablespt_gpu_lib', [
