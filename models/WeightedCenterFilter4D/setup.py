...
setup(
    name='bilateralfilter4D_torch_centerweight',
    version='1.1.0',
    ...
    py_modules=['bilateral_filter_layer_4d_weightedcenter', 'gradcheck'],
    ext_modules=[
        CUDAExtension('bilateralfilter4dweightedcenter_gpu_lib', [
